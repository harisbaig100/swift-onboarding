...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/harisbaig100/swift-onboarding.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'M.Haris Baig' => 'harisbaig100@gmail.com' }
  s.source           = { :git => 'https://github.com/harisbaig100/swift-onboarding.git', :tag => s.version.to_s }
